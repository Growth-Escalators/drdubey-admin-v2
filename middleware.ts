...
export const config = {
  ...
  matcher: [
    '/((?!api/auth|api/campaigns/send-chunk|api/campaigns/run-scheduled|api/campaigns/resume-stalled|api/cron|api/whatsapp/webhook|sign-in|_next/static|_next/image|favicon.ico|images/wa-headers).*)',
  ],
}
